...
public class UserInstanceControllerTest extends AbstractSystemTest {
	...
	public void apiShouldGetUserInstanceListByUser() {
		UserInstanceResponseTO[] responseTOArray = given()
				...
				.extract()
				.body().as(UserInstanceResponseTO[].class);
	...
	public void apiShouldCreateUserInstances() throws Exception {
		UserInstanceResponseTO[] responseTOArray = given()
				...
				.body(getCreateUserInstanceRequestTO()).post(getUrl() + "userInstances/").then()
				.statusCode(HttpStatus.SC_CREATED).extract().body().as(UserInstanceResponseTO[].class);
	...
	public void apiShouldUpdateUserInstance() throws Exception {
		...
		.header(token)
		.header(usercode)
		.body(getUpdateUserInstanceRequestTO()).patch(getUrl() + "userInstances/1")
