...
INSERT INTO `STORAGE_TYPE` (ID, NAME) VALUES (1, 'HDD');
INSERT INTO `STORAGE_TYPE` (ID, NAME) VALUES (2, 'SSD');
...
INSERT INTO `PLAN_STORAGE_TYPE` (ID, PLAN_ID, STORAGE_TYPE_ID, WEIGHT) VALUES (1, 1, 1, 1.0);
INSERT INTO `PLAN_STORAGE_TYPE` (ID, PLAN_ID, STORAGE_TYPE_ID, WEIGHT) VALUES (2, 1, 2, 3.0);

INSERT INTO `INSTANCE` (ID, NAME, CPU, MEMORY, STORAGE, PLAN_ID, STORAGE_TYPE_ID) VALUES (1, 'small', 1, 2, 40, 1, 1);
INSERT INTO `INSTANCE` (ID, NAME, CPU, MEMORY, STORAGE, PLAN_ID, STORAGE_TYPE_ID) VALUES (2, 'medium', 2, 4, 100, 1, 1);
INSERT INTO `INSTANCE` (ID, NAME, CPU, MEMORY, STORAGE, PLAN_ID, STORAGE_TYPE_ID) VALUES (3, 'large', 2, 8, 250, 1, 2);
